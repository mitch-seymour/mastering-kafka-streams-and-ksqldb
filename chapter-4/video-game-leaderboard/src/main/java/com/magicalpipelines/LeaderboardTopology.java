...
class LeaderboardTopology {
  ...
  public static Topology build() {
    ...
    // register the game events stream
     ...
     *
     * <p>Regarding the KeyValueMapper param types: - String is the key type for the gaming events
    ...
    KeyValueBytesStoreSupplier storeSupplier =
        Stores.persistentTimestampedKeyValueStore("leader-boards");
    ...
    KTable<String, HighScores> highScores =
        grouped.aggregate(
            ...
            highScoresAdder,
            Materialized.<String, HighScores>as(storeSupplier)
